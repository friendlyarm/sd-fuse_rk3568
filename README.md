...
```
You can build the following OS: buildroot, debian-buster-desktop-arm64, debian-bullseye-desktop-arm64, friendlycore-focal-arm64, friendlywrt22, friendlywrt22-docker, friendlywrt21, friendlywrt21-docker.
