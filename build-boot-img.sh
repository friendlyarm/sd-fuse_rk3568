...
if [ $# -lt 2 ]; then
    ...
    echo "example:"
    echo "    tar xvzf NETDISK/rk3568/rootfs/rootfs-friendlycore-focal-arm64-20190603.tgz"
    echo "    ./build-boot-img.sh friendlycore-focal-arm64/boot friendlycore-focal-arm64/boot.img"
    exit 1
fi
TOPDIR=$PWD
